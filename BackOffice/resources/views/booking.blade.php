...
<!-- Mirrored from www.codezion.com/themes/tm/html/bicycle/booking.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 26 Sep 2022 02:56:37 GMT -->
...
<head>
    ...
    <title>Bicycle Bootstrap Website Templates | Booking</title>
                                    ...
                                    <ul class="custom-flex">
                                        ...
                                        <li class="menu-item menu-item-has-children"> <a href="#">Inventory</a>
                                            <ul class="submenu custom">
                                                ...
                                                <li class="menu-item"> <a href="bicycle-left-sidebar.html">Left
                                                        Sidebar</a> </li>
                                                <li class="menu-item"> <a href="bicycle-right-sidebar.html">Right
                                                        Sidebar</a> </li>
                                                <li class="menu-item"> <a href="bicycle-detail.html">Bicycle Detail</a>
                                                </li>
                                            </ul>
                                        </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <div class="row mb-md-80">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Verify Email
                                                            I'd</label>
                                                        <input type="email" name="#"
                                                            class="form-control form-control-custom"
                                                            placeholder="Email I'd" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Country
                                                            Code</label>
                                                ...
                                                <div class="col-12">
                                                    <label class="custom-checkbox mb-0">
                                                        ...
                                                        <span class="checkmark"></span> I want to receive <a href="#"
                                                            class="text-custom-blue">Company name</a> promotional offers
                                                        in the future </label>
                                                </div>
                                                <div class="col-12">
                                                    <hr>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Card Holder
                                                            Name</label>
                                                        <input type="text" name="#"
                                                            class="form-control form-control-custom"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Card
                                                            Number</label>
                                                        <input type="text" name="#"
                                                            class="form-control form-control-custom"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                <label class="fs-14 text-custom-black fw-500">Expiration
                                                                    Month</label>
                                                                <div class="group-form">
                                                                    <select
                                                                        class="custom-select form-control form-control-custom">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Billing Zip
                                                            Code</label>
                                                        <input type="text" name="#"
                                                            class="form-control form-control-custom"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Airline
                                                            Name</label>
                                                        <div class="group-form">
                                                            <select
                                                                class="custom-select form-control form-control-custom">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="fs-14 text-custom-black fw-500">Arriving
                                                            Number</label>
                                                        <input type="text" name="#"
                                                            class="form-control form-control-custom"
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="custom-checkbox">
                                                            <input type="checkbox" name="#">
                                                            <span class="checkmark"></span> By continuing, you agree to
                                                            the <a href="#" class="text-custom-blue">Terms and
                                                                Conditions.</a> </label>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="bicycle-grid mb-xl-30">
                                                        <div class="bicycle-grid-wrapper bx-wrapper">
                                                            <div class="image-sec animate-img"> <a href="#"> <img
                                                                        src="{{asset('/images/bicycle/cy-3.jpg')}}"
                                                                        class="full-width" alt="img"> </a> </div>
                                                            <div
                                                                class="bicycle-grid-caption padding-20 bg-custom-white p-relative">
                                                                <h4 class="title fs-16"><a href="#"
                                                                        class="text-custom-black">Economy<small
                                                                            class="text-light-dark">Per Day</small></a>
                                                                </h4>
                                                                <span class="price"><small>From</small>$58</span>
                                                                <div class="action"> <a class="btn-second btn-small"
                                                                        href="#">View</a> <a
                                                                        class="btn-first btn-submit" href="#">Book</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="need-help bx-wrapper padding-20">
                                                        ...
                                                        <p class="text-light-dark">We would be more than happy to help
                                                            you. Our team advisor are 24/7 at your service to help you.
                                                        </p>
                                                        <ul class="custom">
                                                            <li class="text-custom-blue fs-18"> <i
                                                                    class="fas fa-phone-alt"></i> <a href="#"
                                                                    class="text-light-dark">(+347) 123 456 7890</a>
                                                            </li>
                                                            <li class="text-custom-blue fs-18"> <i
                                                                    class="fas fa-envelope"></i> <a href="#"
                                                                    class="text-light-dark fs-14"><span
                                                                        class="__cf_email__"
                                                                        data-cfemail="157d70796555717a78747c7b3b767a78">[email&#160;protected]</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-box mb-md-40">
                        ...
                        <p class="text-custom-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                            ...
                            eiusmod tempor incididunt.Lorem ipsum dolor sit amet... </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="footer-box mb-md-40">
...
<script src="{{asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyDnd9JwZvXty-1gHZihMoFhJtCXmHfeRQg')}}"></script>
